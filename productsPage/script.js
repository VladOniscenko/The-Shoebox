        ...
        (function() {
            ...
            <div class="product_obj">
                <a class="hoverALink" href="./oneProductPage/oneProductPage.html?id=${shoes[i].product_id}">
                    <div class="img_obj">
                        <img class="product_img" src="https://oniscenko.com/projects/project2/imgs/${shoes[i].product_id}/img%20%28${afbeelding1}%29.png" alt="">
                    </div>
                    <div class="shoe_info">
...
function getAllShoes(){
    ...
    xhr.onload = success;
    xhr.onerror = error;
    xhr.open('GET', '/projects/project2/productsPage/jsons/jsonRead.php', true);
    ...
    arraytje[i].addEventListener('click', (e)=>{
        if(e.target.checked){
            ...
            function getSortShoes(){
                ...
                xhr.onload = success;
                xhr.onerror = error;
                xhr.open('GET', `/projects/project2/productsPage/jsons/jsonRead.php?product_type=${soort}`, true);
                xhr.send();
            }
            getSortShoes()
        }
